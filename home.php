...
<meta name="theme-color" content="#ffffff" />-->
    <link rel="stylesheet" href="./assets/css/stylesforhome.prefixed.css" />
...
<nav class="nav--main" role="navigation" itemscope="" itemtype="https://schema.org/SiteNavigationElement">
    <ul class="nav--list is-visible" id="js-nav--main-list">
            ...
            <li class="nav--list-item">
				<a href="./home.php" class="nav--list-link " >Towfiq Chowdhury</a><!--logo--link--> <!--style="font-size: 140%; font-weight: bold;"-->
			</li>   
			<li class="nav--list-item">
            ...
            <li class="nav--list-item">
			<a data-scroll="" href="./contact.php" class="nav--list-link">Contact</a>
			</li>
    </ul>
</nav>
...
<main style="background: black;color:white;" class="page--main">
    <section class="block---padded-top">
        <!-- @component tiles -->

<div class="tiles u-display-flex" data-max-ratio="1.5">
      <?php
	$mysql = "SELECT * from shopkeeper where shop_name!='Slider' AND shop_name!='About' AND shop_name!='Gallery'";
	...
	if($num>0)
	{
		...
		{
	?>
          	  <div class="tile-item"  class="home-margin">
            	  <div class="tile-item--content">
                <figure class="tile-item--content-figure" >
                    <a class="tile-item--content-link" href="details.php?id=<?=$row['id']?>">
                            <!-- @component respimage -->
<img  style="height: 180px !important; width: 550px !important;" src="manager/site_img/header_image/<?php echo $row['header_img']; ?>"/>
    <!-- @end respimage -->
                    </a>
                    <figcaption class="tile-item--content-caption">
                        <a href="details.php?id=<?php echo $row['id']?>">
                            <?php echo $row['shop_name']; ?>                        </a>
                    </figcaption>
                </figure>
            </div>
        </div>
